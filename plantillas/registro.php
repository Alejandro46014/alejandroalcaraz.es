...
<div class="contenedor">
	<div class="formulario clearfix">
		...
		<label for="password_usuario">Contraseña</label>
			<input type="text" name="password_usuario" id="password_usuario" pattern="?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="ej: Masdem22" title="La contraseña debe contener minúsculas, mayúsculas, números y tener una longitud de 8 caracteres"/>
			</div>
			
			<div class="col_2_formulario">
		<label for="password_usuario">Repite contraseña</label>
			<input type="text" name="rpassword_usuario" id="rpassword_usuario"/>
			</div>
			
			<div class="col_formulario">
			<input type="submit" name="login" id="login" class="buttom_green" value="Registro"/>
			</div>
		</form>
